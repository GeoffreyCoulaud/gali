...
const BragMainWindow    = require("./BragMainWindow/widget.js");
const BragGameGridChild = require("./BragGameGridChild/widget.js");
...
const FB_BOXART = path.resolve(`${__dirname}/../icons/white/image_not_found.svg`);
// eslint-disable-next-line no-unused-vars
const FB_COVER  = path.resolve(`${__dirname}/../icons/white/image_not_found_wide.svg`);
// eslint-disable-next-line no-unused-vars
const FB_ICON   = path.resolve(`${__dirname}/../icons/white/image_not_found_square.svg`);
