...
const { DesktopEntrySource } = require("../src/desktop-entries.js");
const { LegendarySource }    = require("../src/legendary.js");
const { RetroarchSource }    = require("../src/retroarch.js");
const { DolphinSource }      = require("../src/dolphin.js");
const { HeroicSource }       = require("../src/heroic.js");
const { LutrisSource }       = require("../src/lutris.js");
const { PPSSPPSource }       = require("../src/ppsspp.js");
const { CitraSource }        = require("../src/citra.js");
const { SteamSource }        = require("../src/steam.js");
const { CemuSource }         = require("../src/cemu.js");
const { YuzuSource }         = require("../src/yuzu.js");
